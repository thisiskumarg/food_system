...
?>
<div class="col-sm-10">
    <h2 class="section-title position-relative text-uppercase text-center mb-4"><span class="bg-secondary pr-3">Edit Non - Verified Customer</span></h2>
    <h5 class="text-center text-danger"><?php echo $this->session->flashdata('msg'); ?></h5>
    <form action="<?php echo site_url('Welcome/updatenvc/').$uid; ?>" method="POST" enctype="multipart/form-data">
