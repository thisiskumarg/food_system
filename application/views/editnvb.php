...
?>
<div class="col-sm-10">
    <h2 class="section-title position-relative text-uppercase text-center mb-4"><span class="bg-secondary pr-3">Edit Non - Verified Business</span></h2>
    ...
    <form action="<?php echo site_url('Welcome/updatenvb/').$bsno; ?>" method="POST" enctype="multipart/form-data">
