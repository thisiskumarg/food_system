...
?>
<div class="col-sm-10">
    <h2 class="section-title position-relative text-uppercase text-center mb-4"><span class="bg-secondary pr-3">Edit Suspended Product</span></h2>
    <?php echo '<h3 class="text-center text-danger">'.$this->session->flashdata('msg').'</h3>'; ?>
    <form action="<?php echo site_url('Welcome/updatesp/').$psno; ?>" method="POST" enctype="multipart/form-data">
