...
<head>
    <meta charset="utf-8">
    <title>Vendor - Local Bazar</title>
        ...
        <div class="row">
            <div class="col-sm-2">
                <div class="list-group">
                    <a href="#" class="list-group-item list-group-item-action text-dark active" aria-current="true">Vendor Dashboard</a>
                    <a href="<?php echo site_url('Welcome/profile'); ?>" class="list-group-item list-group-item-action">My Account</a>
                    <?php 
                    if(!empty($vendorresult))
                    {
                        echo '<a href="#" class="list-group-item list-group-item-action">Add Business</a>';
                    }
                    else
                    {
                        echo '<a href="'.site_url('Welcome/addbusinessform').'" class="list-group-item list-group-item-action">Add Business</a>';
                    }
                    ?>
                    <a href="<?php echo site_url('Welcome/venbusiness'); ?>" class="list-group-item list-group-item-action">My Business</a>
                    <?php 
                    if(!empty($vendorresult))
                    {
                        foreach($vendorresult as $vendorrow)
                        {
                            $vendorv = $vendorrow['bis_ver'];
                        }
                        if($vendorv == '1')
                        {
                            echo '<a href="'.site_url('Welcome/addproductform').'" class="list-group-item list-group-item-action">Add Product</a>';
                        }
                        else
                        {
                            echo '<a href="#" class="list-group-item list-group-item-action">Add Product</a>';
                        }
                    }
                    else
                    {
                    ...
                    <a href="<?php echo site_url('Welcome/areviews'); ?>" class="list-group-item list-group-item-action">Reviews</a>
                    <a href="<?php echo site_url('Welcome/anotifications'); ?>" class="list-group-item list-group-item-action">Notifications</a>
                </div>
            </div>
