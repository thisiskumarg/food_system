                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <!-- <a href="<?php //echo site_url('Welcome/detail'); ?>" class="nav-item nav-link">Shop Detail</a>
                            ...
                            if(isset($_SESSION['uid']))
                            {
                                ...
                                {
                                    echo '<a href='.site_url('Welcome/profile').' class="nav-item nav-link">'.$row['name'].'</a>';
                                }
        ...
        <div class="row">
            <div class="col-sm-2">
                <div class="list-group">
                    <a href="#" class="list-group-item list-group-item-action text-dark active" aria-current="true">User Dashboard</a>
                    <a href="<?php echo site_url('Welcome/profile'); ?>" class="list-group-item list-group-item-action">My Account</a>
                    <a href="<?php echo site_url('Welcome/uorders'); ?>" class="list-group-item list-group-item-action">My Orders</a>
                    <a href="<?php echo site_url('Welcome/ureviews'); ?>" class="list-group-item list-group-item-action">My Reviews</a>
                </div>
            </div>
